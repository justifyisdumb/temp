    ...
    <main className="min-h-screen bg-black relative overflow-hidden">
      ...
      {!isLoading && (
        <>
          ...
          <div 
  className="absolute top-3/4 left-8 z-20 cursor-pointer hover:scale-110 hover:shadow-2xl hover:bg-white/30 transition-all duration-500 ease-out"
  style={{
    transform: 'perspective(1000px) rotateY(45deg)',
  }}
>
  <div className="bg-white/15 backdrop-blur-sm rounded-lg px-32 py-20 shadow-xl border border-gray-200/30">
    <h3 className="text-gray-800 font-bold text-7xl tracking-wide">PROJECTS</h3>
  </div>
</div>

{/* ABOUT card - far right, upper */}
<div 
  className="absolute top-1/4 right-16 z-20 cursor-pointer hover:scale-110 hover:shadow-2xl hover:bg-white/30 transition-all duration-500 ease-out"
  style={{
    transform: 'perspective(1000px) rotateY(-40deg)',
  }}
>
  <div className="bg-white/15 backdrop-blur-sm rounded-lg px-32 py-20 shadow-xl border border-gray-200/30">
    <h3 className="text-gray-800 font-bold text-7xl tracking-wide">ABOUT</h3>
  </div>
</div>

{/* CONTACT card - far right, lower */}
<div 
  className="absolute top-2/3 right-16 z-20 cursor-pointer hover:scale-110 hover:shadow-2xl hover:bg-white/30 transition-all duration-500 ease-out"
  style={{
    transform: 'perspective(1000px) rotateY(-35deg)',
  }}
>
  <div className="bg-white/15 backdrop-blur-sm rounded-lg px-32 py-20 shadow-xl border border-gray-200/30">
    <h3 className="text-gray-800 font-bold text-7xl tracking-wide">CONTACT</h3>
  </div>
</div>
